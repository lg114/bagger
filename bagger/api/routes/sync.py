...
def _run_scan(full: bool) -> None:
    ...
    HTTP request returns before the scan finishes. Any failure is recorded via
    ``scan_state.mark_error`` and surfaced to the poller rather than crashing the
    worker or the request.
    """
